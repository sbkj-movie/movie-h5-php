...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix">
			...
			<input type="hidden" name="is_vip" id="is_vip" value="<?php echo ($data['SHID']?1:0); ?>">
               ...
               <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">  
                       ...
                       <select name="tid"  lay-filter="tid"  id="tid"  required class="layui-select " <?php if(isset($data['SHID'])): ?>disabled<?php endif; ?>>
