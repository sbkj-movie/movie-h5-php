...
<section class="layui-larry-box">
	<div class="larry-personal" >
	    <div class="layui-tab">
			...
			<a class="layui-btn layui-btn-normal newsAdd_btn" href="<?php echo U('shezhi/kefuadd');?>" >添加客服</a>
			</div>
                     ...
                     <table class="layui-table table-hover" lay-even="" lay-skin="nob">
                          ...
                          <tbody>
                           <?php if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($data['CS_TYPE']); ?></td>
                                            <td><?php echo ($data['CS_NUMBER']); ?></td>
