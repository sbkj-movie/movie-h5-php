            ...
            <input type="hidden" name="pg" id="pg" value="<?php echo ($data['pg']?$data['pg']:'1'); ?>">
                ...
                <div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="radio" name="type" value="1" lay-filter="type"  title="支付宝扫码"  <?php if(isset($data['HU_TYPE'])&&$data['HU_TYPE']==1 ): ?>checked="checked"<?php endif; ?>><div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon"></i><span>支付宝扫码</span></div>
						<input type="radio" name="type" value="3" lay-filter="type"  title="微信扫描"  <?php if(isset($data['HU_TYPE'])&&$data['HU_TYPE']==3 ): ?>checked="checked"<?php endif; ?>><div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon"></i><span>微信扫码</span></div>
					</div>
				</div>
                 <div class="layui-form-item">
