	...
	<div class="paster">
			...
			<?php if(isset($message)): ?><img src="/Public/admin/images/success.png"/>
				<div>
					...
					<p>页面自动 <a id="href" target="_top" _href="<?php echo($jumpUrl); ?>">跳转</a> 等待时间： <b id="wait"><?php echo($waitSecond); ?></b></p>
				</div>
			<?php else: ?>
...
(function(){
var wait = document.getElementById('wait'),href = $('#href').attr('_href');
