...
//            $my_plugin_id = 'my-plugins-id';
            if ($_GET['f'] && $_GET['f'] == 1) {
                $return_url = $serverHost . '/users/appPaySuccess.html';
//				$callback_url=$domain.'/users/appPayerr.html';
            } else {
                $return_url = $serverHost . '/users/webPaySuccess.html';
//				$callback_url=$domain.'/users/webPayerr.html';
            ...
            if ($type == 1 || $type == 3) {
                ...
                $data['notifyUrl'] = $serverHost . '/index.php/app/notify.html';
                ...
                $param_arr = array(
                    ...
                    'subject' => 'VIP会员购买',
                    'body' => 'VIP会员购买',
                    'notifyUrl' => $serverHost . '/index.php/app/receive_message.html',//具体的回调地址
                    'signType' => 'RSA'
