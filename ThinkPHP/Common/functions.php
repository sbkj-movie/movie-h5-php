...
function subs($appid,$secret,$openid){
	$url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=".$appid."&secret=".$secret;
	$data = GetOpenidFromMp($url);
	$url = "https://api.weixin.qq.com/cgi-bin/user/info?access_token=".$data['access_token']."&openid=".$openid;
	$user = GetOpenidFromMp($url);
	return $user;
}

function getopenid($url,$appid,$secret){
	if(!isset($_GET['code'])){
