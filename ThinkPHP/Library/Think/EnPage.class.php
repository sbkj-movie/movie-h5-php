...
class EnPage {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'records','prev'=>'previous page','next'=>'next page','first'=>'first page','last'=>'last page','theme'=>' %totalRow% %header% %nowPage%/%totalPage% page %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
    // 默认分页变量名
    protected $varPage;
