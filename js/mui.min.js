...
!function (a, b) {
    ...
    if(/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
        ...
        var width = "20%";
        var centerWidth = "40%";
        document.body.style.width = width;//body宽度设置
        document.body.style.margin = "auto";
        if(document.querySelector('header')){//顶部title设置
            document.querySelector('header').style.width = width;
            document.querySelector('header').style.marginLeft = centerWidth;
        }

        if(document.querySelector('nav')){//底部菜单宽度设置
            document.querySelector('nav').style.width = width;
            document.querySelector('nav').style.marginLeft = centerWidth;
        }

        if(document.getElementsByClassName("mui-scroll-wrapper")[0]){
            document.getElementsByClassName("mui-scroll-wrapper")[0].style.width = width;
            document.getElementsByClassName("mui-scroll-wrapper")[0].style.marginLeft = centerWidth;
        }

        if(document.getElementsByClassName("down")[0]){//顶部app下载提示宽度设置
            document.getElementsByClassName("down")[0].style.width = width;
        }

        if(document.getElementsByClassName("header")[0]){//顶部header设置
            document.getElementsByClassName("header")[0].style.width = width;
        }

        if(document.getElementsByClassName("bottom")[0]){//顶部header设置
            document.getElementsByClassName("bottom")[0].style.width = width;
        }
